...
#define SOME_AMOUNT_I_DONT_REALLY_CARE  750 // meters
...
//  }
  ...
  if(( abs(y_rotation - ref_Y) >= 75 || abs(z_rotation - ref_Z) >= 75)&& (altitude > SOME_AMOUNT_I_DONT_REALLY_CARE))/* */
  {
